<script>
  ...
  //fetching specific playlists for top rap
  let deezer_rap = [
    "1996494362", "6682665064",
    "10709033662", "1677006641",
    "10581717182", "7860734322"
  ];
  ...
  for (let i = 0; i < deezer_rap.length; i++) {
    fetch(
      "https://deezerdevs-deezer.p.rapidapi.com/playlist/" + deezer_rap[i],
      options
    )
