...
var get_default_slot_context = (ctx) => ({
  ...
  handleSubmit: ctx[5],
  updateField: ctx[6],
  updateInitialValues: ctx[7],
  updateTouched: ctx[8],
  updateValidateField: ctx[9],
  validateField: ctx[10]
});
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(form_1, file, 49, 0, 970);
    },
    ...
    m: function mount(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = listen_dev(form_1, "submit", ctx[5], false, false, false);
        mounted = true;
      }
    },
    p: function update2(ctx2, [dirty]) {
      ...
      set_attributes(form_1, form_1_data = get_spread_update(form_1_levels, [dirty & 2048 && ctx2[11]]));
    },
...
function create_fragment2(ctx) {
  ...
  let textarea_levels = [
    ...
    ctx[4],
    {
      value: textarea_value_value = ctx[1][ctx[0]]
    }
  ];
  let textarea_data = {};
  ...
  const block = {
    c: function create() {
      ...
      add_location(textarea, file2, 10, 0, 190);
    },
    l: function claim(nodes) {
    ...
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        dispose = [
          listen_dev(textarea, "change", ctx[3], false, false, false),
          listen_dev(textarea, "blur", ctx[3], false, false, false)
        ];
        mounted = true;
      }
    },
    p: function update2(ctx2, [dirty]) {
      set_attributes(textarea, textarea_data = get_spread_update(textarea_levels, [
        dirty & 1 && { name: ctx2[0] },
        dirty & 16 && ctx2[4],
        dirty & 3 && textarea_value_value !== (textarea_value_value = ctx2[1][ctx2[0]]) && { value: textarea_value_value }
      ]));
    },
    i: noop,
    o: noop,
...
function create_fragment3(ctx) {
  ...
  let input_levels = [
    ...
    { type: ctx[1] },
    {
      value: input_value_value = ctx[2][ctx[0]]
    },
    ctx[5]
  ];
  let input_data = {};
  ...
  const block = {
    c: function create() {
      ...
      add_location(input, file3, 10, 0, 193);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        dispose = [
          ...
          listen_dev(input, "blur", ctx[4], false, false, false)
        ];
        mounted = true;
      }
    },
    p: function update2(ctx2, [dirty]) {
      set_attributes(input, input_data = get_spread_update(input_levels, [
        dirty & 1 && { name: ctx2[0] },
        dirty & 2 && { type: ctx2[1] },
        dirty & 5 && input_value_value !== (input_value_value = ctx2[2][ctx2[0]]) && input.value !== input_value_value && { value: input_value_value },
        dirty & 32 && ctx2[5]
      ]));
...
function create_fragment4(ctx) {
  ...
  let select_levels = [
    { name: ctx[0] },
    {
      value: select_value_value = ctx[1][ctx[0]]
    },
    ctx[4]
  ];
  let select_data = {};
  ...
  const block = {
    c: function create() {
      ...
      add_location(select, file4, 9, 0, 164);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    m: function mount(target, anchor) {
      ...
      if (!mounted) {
        dispose = [
          listen_dev(select, "change", ctx[3], false, false, false),
          listen_dev(select, "blur", ctx[3], false, false, false)
        ];
        mounted = true;
      }
    },
    p: function update2(ctx2, [dirty]) {
      ...
      set_attributes(select, select_data = get_spread_update(select_levels, [
        (!current || dirty & 1) && { name: ctx2[0] },
        (!current || dirty & 3 && select_value_value !== (select_value_value = ctx2[1][ctx2[0]])) && { value: select_value_value },
        dirty & 16 && ctx2[4]
      ]));
      if (dirty & 19 && "value" in select_data)
        (select_data.multiple ? select_options : select_option)(select, select_data.value);
    },
    i: function intro(local) {
      if (current)
...
function create_if_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(small, file5, 10, 2, 175);
    },
    m: function mount(target, anchor) {
    ...
    p: function update2(ctx2, dirty) {
      ...
      set_attributes(small, small_data = get_spread_update(small_levels, [dirty & 8 && ctx2[3]]));
    },
    d: function destroy(detaching) {
      if (detaching)
        detach_dev(small);
...
function create_fragment5(ctx) {
  let if_block_anchor;
  let if_block = ctx[1][ctx[0]] && create_if_block(ctx);
  const block = {
    c: function create() {
      if (if_block)
        if_block.c();
